...
namespace Mirror
{
	...
	public static class NetworkTime
	{
		...
		private static bool connectedAndSentPingMessage = false;

		public static void Reset()
		{
			connectedAndSentPingMessage = false;
			stopwatch.Restart();
		...
		internal static void UpdateClient()
		{
			...
			if (localTime - lastPingTime >= PingFrequency || !connectedAndSentPingMessage)
			{
				connectedAndSentPingMessage = true;
